...
- Only conservative forces can change the potential energy of a system
$$
	W^C = -(U \tiny gf \normalsize - U \tiny gi \normalsize)
$$
==Types of Energy==: 
...
- Sound Energy
### Law of Conservation of Energy (Work Energy theorem)
$$
	W = \Delta K + \Delta U + \Delta E \tiny nonmechanical \normalsize = 0
$$
...
- *To say a physical quantity is conserved is to say that the numerical value of a quantity will remain constant despite a physical process occurring.*
$$
	K_i+U_i=K_f+U_f
$$
	- Where U is potential energy & K is kinetic energy
### When Forces are Not Conserved
$$
	W^N = \Delta E
$$
- Work of Non-Conservative Forces is equal to the change in energy
...
$$
## Derivation for Work-Kinetic Energy Theorem
